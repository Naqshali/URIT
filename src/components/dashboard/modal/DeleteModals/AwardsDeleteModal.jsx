export default function AwardsDeleteModal({ action }) {
  return (
    <>
      <div
        className="modal fade"
        id="awardsDeleteModal"
        tabIndex={-1}
        aria-labelledby="awardsDeleteModalLabel"
        aria-hidden="true"
      >
            ...
            <div className="modal-body px-4 pt-5">
              <div className="pb20">
                ...
                <p className="text-center">
                  Do you really want to delete this <strong>award</strong>{" "}
